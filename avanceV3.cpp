...
void menu(int opcion) {
    ...
    char titulo [5][25] = {"Sucursal", "Proveedor", "Articulo","Movimientos ArtÃ­culos", "Reporte"};
...
void enConstruccion () {
    cout<<"\nEsta funciÃ³n actualmente se encuentra en construcciÃ³n, regrese cuando se lance el programa de forma completa.\n";
